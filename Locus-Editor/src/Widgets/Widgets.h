...
namespace Locus::Widgets
{
	...
	void DrawMaterialDropdown(const std::string& name, MaterialHandle& materialHandle, float labelWidth = -1.0f, float inputWidth = -1.0f);
	void DrawModelDropdown(const std::string& name, ModelHandle& modelHandle, float labelWidth = -1.0f, float inputWidth = -1.0f);
