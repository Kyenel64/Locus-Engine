	...
	void OpenGLFramebuffer::Refresh()
	{
		...
		if (m_ColorAttachmentSpecifications.size())
		{
			...
			for (size_t i = 0; i < m_ColorAttachments.size(); i++)
			{
				...
				{
					case FramebufferTextureFormat::RGBA8: Utils::AttachColorTexture(m_ColorAttachments[i], m_Specification.Samples, 
						GL_RGBA8, m_Specification.Width, m_Specification.Height, (GLsizei)i);
		...
		if (m_DepthAttachmentSpecification.TextureFormat != FramebufferTextureFormat::None)
		{
			...
			{
				case FramebufferTextureFormat::DEPTH24STENCIL8: Utils::AttachDepthTexture(m_DepthAttachment, m_Specification.Samples, 
